...
import {
    Check, X, AlertCircle, Activity, Zap, Stethoscope, RefreshCw, Download, ArrowUp
} from 'lucide-react';
        ...
        <motion.div variants={itemVariants} className="space-y-6">
            ...
            <Card>
                ...
                <div className="space-y-3">
                    ...
                    {/* Hugo Status with Version */}
                    {renderToolStatus('hugo', 'Hugo', systemHealth?.hugoInstalled, getVersionInfo('hugo'), true)}
                    ...
                    {/* Auto Install Button - Only show if something is missing */}
                    {!allInstalled && (
                        <motion.button
                            onClick={onCheckDeps}
                            disabled={installing?.installing || allInstalled}
